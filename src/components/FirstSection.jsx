...
export const FirstSection = () => {
  return (
    <section className='p-40 flex flex-col items-center m-auto w-full justify-center'>
      <div className='relative flex items-center w-screen lg:w-full'>
        ...
        <div className='relative m-auto'>
          <div className='rounded-full bg-gradient-to-b from-gray-400 via-gray-600 to-blue-800 absolute inset-0 m-auto blur-[40px] w-80 h-80 lg:w-72 lg:h-72 opacity-50'></div>
